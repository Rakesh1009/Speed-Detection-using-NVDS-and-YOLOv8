...
namespace YOLOv8 {
  ...
  int
  Odin::create_input_sources(gpointer pipe, gpointer mux, guint num_sources) {
  ...
  Odin::calculate_object_speed(NvDsObjectMeta *obj_meta){
    ...
    double size_of_obj = sqrt(obj_meta->rect_params.width * obj_meta->rect_params.width +
                              obj_meta->rect_params.height * obj_meta->rect_params.height) / 2.0;
